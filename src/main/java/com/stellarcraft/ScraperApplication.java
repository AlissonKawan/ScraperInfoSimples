...
public class ScraperApplication {
    ...
    // Adicionado @JsonProperty para bater exatamente com a tabela de exigências da Infosimples
    ...
    public static void main(String[] args) {
        try {
            ...
            if (!input.exists()) {
                System.err.println("Arquivo page.html não encontrado no diretório atual.");
                return;
            }
            
            Document doc = Jsoup.parse(input, "UTF-8", "https://storage.googleapis.com/infosimples-output/stellarcraft/case/");
            ...
            System.out.println("Extração concluída com sucesso! JSON estruturado salvo em: " + outputFile.getAbsolutePath());
    ...
    private static Integer calculateScore(String starsStr) {
        ...
        for (char c : starsStr.toCharArray()) {
            // Suporta tanto o caractere preenchido quanto possíveis variações de renderização
            if (c == '★' || c == '\u2605') {
                count++;
            }
        }
